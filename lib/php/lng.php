...
$__lng = array(
	...
	'paths'=>array(),
	'hooks'=>array(),
	'error_mode'=>'return_id', // or 'return_id'
	'error_msg'=>'Phrase could not be located',
);
...
class lng
{
	...
	public static function find_phrase($phrase)
	{
		global $__lng;
	...
	public static function translate($phrase,$parameters=array())
	{
		global $__lng;
		...
		if(!isset($__lng['phrases'][$phrase]))
		{
			...
			else if($__lng['error_mode'] == 'return_id')
				return $phrase;
			else if($__lng['error_mode'] == 'return_msg')
				return $__lng['error_msg'];
		}
	...
	{
		return lng::translate($phrase,$parameters);
